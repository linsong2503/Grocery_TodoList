...
const seedItems = [
  ...
  { name: "Vinamilk", category: "Dairy", quantity: 2, priority: "medium", purchased: true },
  { name: "Cheese", category: "Dairy", quantity: 1, priority: "low", purchased: false },
  { name: "Bread", category: "Bakery", quantity: 1, priority: "high", purchased: false },
  ...
  { name: "KitKat", category: "Snacks", quantity: 5, priority: "medium", purchased: false },
  { name: "Chocolate", category: "Snacks", quantity: 2, priority: "low", purchased: false },
  { name: "Eggs", category: "Dairy", quantity: 12, priority: "high", purchased: false },
  { name: "Ground Beef", category: "Food", quantity: 24, priority: "high", purchased: false },
  { name: "Pork", category: "Food", quantity: 36, priority: "high", purchased: false },
];
